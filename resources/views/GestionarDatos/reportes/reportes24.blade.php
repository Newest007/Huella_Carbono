...
@csrf
    ...
    <div class="pcoded-content">
        ...
        <div class="container mt-4">
            ...
            <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="GenerarReporteDos">Año 2022</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="GenerarReporteTres">Consumo 2023</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="GenerarReporteCuatro">Consumo 2024</a>
                </li>
                <li class="nav-item">
