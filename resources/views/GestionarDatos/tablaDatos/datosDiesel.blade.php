    ...
    <div class="pcoded-content">
        ...
        <div class="container mt-4">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="VerDatosDiesel">Consumo Diesel</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal fade" id="eliminar{{$diesel->id_colegio}}{{$diesel->id_Anio}}{{$diesel->Mes}}" tabindex="-1" role="dialog" aria-labelledby="eliminar{{$diesel->id_colegio}}{{$diesel->id_Anio}}{{$diesel->Mes}}Label" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('datosDiesel.destroy', ['id_colegio' => $diesel->id_colegio, 'id_Anio' => $diesel->id_Anio, 'Mes' => $diesel->Mes] )}}">
                        @csrf
                        @method('DELETE')
